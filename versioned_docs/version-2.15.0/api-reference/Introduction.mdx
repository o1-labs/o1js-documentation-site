...
| [Bool](type-aliases/Bool.mdx) | A boolean value. You can create it like this: |
| [BoolVar](type-aliases/BoolVar.mdx) | - |
| [Bytes](type-aliases/Bytes.mdx) | A provable type representing an array of bytes. |
...
| [Group](type-aliases/Group.mdx) | An element of a Group. |
...
| [Option](type-aliases/Option.mdx) | Define an optional version of a provable type. |
...
| [Struct](type-aliases/Struct.mdx) | `Struct` lets you declare composite types for use in o1js circuits. |
...
| [TransactionDepthInfo](type-aliases/TransactionDepthInfo.mdx) | Information about a transaction's depth (confirmation count) in the blockchain. Depth represents how many blocks have been built on top of the block containing the transaction. |
...
| [ZkProgram](type-aliases/ZkProgram.mdx) | Wraps config + provable code into a program capable of producing [Proof](classes/Proof.mdx)s. |
...
| [Poseidon](variables/Poseidon.mdx) | Applies the full Poseidon permutation to the provided state. |
...
| [fetchCurrentSlot](functions/fetchCurrentSlot.mdx) | Fetches the current slot number of the Mina network. |
...
| [fetchTimedAccountInfo](functions/fetchTimedAccountInfo.mdx) | Fetches detailed balance information for a time-locked account. |
| [fetchTransactionDepth](functions/fetchTransactionDepth.mdx) | Fetches the depth (confirmation count) of a transaction in the blockchain. Depth represents how many blocks have been built on top of the block containing the transaction. |
...
| [getBackendPreference](functions/getBackendPreference.mdx) | Retrieve the currently set backend preference. |
| [getBlindingValue](functions/getBlindingValue.mdx) | - |
| [initializeBindings](functions/initializeBindings.mdx) | Include in this file all the exports that should be part of the public API. |
...
| [setBackend](functions/setBackend.mdx) | Set the backend to use for cryptographic operations such as proving. |
