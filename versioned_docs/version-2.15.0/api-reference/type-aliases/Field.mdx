...
Defined in: [lib/provable/wrapped.ts:42](https://github.com/o1-labs/o1js/blob/6d089a824781b83f5d4faa1ceebcb9612ae72411/src/lib/provable/wrapped.ts#L42)

A [Field](../variables/Field.mdx) is an element of a prime order [finite field](https://en.wikipedia.org/wiki/Finite_field).
Every other provable type is built using the [Field](../variables/Field.mdx) type.
...
the value to convert to a [Field](../variables/Field.mdx)

## Returns

A [Field](../variables/Field.mdx) with the value converted from the argument
