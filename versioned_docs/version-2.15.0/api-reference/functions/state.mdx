...
Defined in: [lib/mina/v1/state.ts:100](https://github.com/o1-labs/o1js/blob/6d089a824781b83f5d4faa1ceebcb9612ae72411/src/lib/mina/v1/state.ts#L100)
...
### type
  ...
  \| [`ProvableTypePure`](../type-aliases/ProvableTypePure.mdx)\<`A`\>
  \| [`FlexibleProvablePure`](../type-aliases/FlexibleProvablePure.mdx)\<`A`\>
