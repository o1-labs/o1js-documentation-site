...
:::info[o1js 2.15.0 — Native prover available]
o1js 2.15.0 now ships with the **native prover**. Run proofs natively for significantly faster
proving times. See [Native Prover](/docs/advanced-concepts/native-prover.mdx) to get started.
:::
