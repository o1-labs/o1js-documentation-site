...
Defined in: [lib/proof-system/workers.ts:15](https://github.com/o1-labs/o1js/blob/f8f5fe4735ab2d63dee8db07178075855e11c71a/src/lib/proof-system/workers.ts#L15)
