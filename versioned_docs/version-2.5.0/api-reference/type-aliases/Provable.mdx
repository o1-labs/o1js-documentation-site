...
Defined in: [lib/provable/types/provable-intf.ts:27](https://github.com/o1-labs/o1js/blob/df1ff77af12d7cbbed4a6167f02815fad4f0dceb/src/lib/provable/types/provable-intf.ts#L27)
...
This function is the reverse operation of calling [toFields](Provable.mdx#tofields) and [toAuxiliary](Provable.mdx#toauxiliary) methods on an element of type `T`.
