...
Defined in: [lib/provable/provable.ts:46](https://github.com/o1-labs/o1js/blob/df1ff77af12d7cbbed4a6167f02815fad4f0dceb/src/lib/provable/provable.ts#L46)
...
Generalization of [Provable.if](Provable.mdx#if) for choosing between more than two different cases.
...
Example for decomposing a 64-bit integer into two 32-bit limbs. [Provable.witness](Provable.mdx#witness) will
...
See [Provable.witness](Provable.mdx#witness) for more information.
...
Witness a tuple of field elements. This works just like [Provable.witness](Provable.mdx#witness),
...
[`Provable`](../type-aliases/Provable.mdx)\<`T`, `any`\>
