...
```ts file=../snippets/zkapps/actions-reducers/actions-reducers.ts start=start_reducer end=end_reducer
```
...
Also, see the API reference for [Reducers](/docs/api-reference/variables/Reducer).