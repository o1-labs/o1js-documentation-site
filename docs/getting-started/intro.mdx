...
:::info[o1js 3.0.0 — Mesa release]
o1js 3.0.0 targets the **Mesa** hard fork of the Mina protocol. All verification keys change,
so deployed zkApps must be upgraded — see the
[MESA upgrade guide](/docs/zkapps/upgrade-mesa.mdx) to migrate.
:::
