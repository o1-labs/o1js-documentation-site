---
title: Condiitonal Logic in Constraint Systems
---
...
It is valid to execute code in both sides of the condition, as long as you understand the implications!

```ts file=../../snippets/conditional-logic/conditional-logic.ts start=start_valid_execution_with_function end=end_valid_execution_with_function
```