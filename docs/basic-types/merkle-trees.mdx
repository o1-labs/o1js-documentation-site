...
Read more at the language reference: [IndexedMerkleMap](/docs/api-reference/namespaces/Experimental/variables/IndexedMerkleMap.mdx), [MerkleTree](/docs/api-reference/classes/MerkleTree.mdx), [MerkleWitness](/docs/api-reference/classes/BaseMerkleWitness.mdx), [MerkleList](/docs/api-reference/classes/MerkleList.mdx).
