...
type PendingTransaction = Pick<TransactionCommon, "transaction" | "toJSON" | "toPretty"> & {
  ...
  setFeePerAccountUpdate: TransactionPromise<boolean, false>;
  wait: Promise<IncludedTransaction>;
};
```

Defined in: [lib/mina/v1/transaction.ts:207](https://github.com/o1-labs/o1js/blob/cc18a919fe40be152afb1b603c57d74a9b2225b0/src/lib/mina/v1/transaction.ts#L207)
...
setFeePerAccountUpdate is the same as [(newFeePerAccountUpdate)](Transaction.mdx) but for a PendingTransaction.
