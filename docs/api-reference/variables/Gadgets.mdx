...
Defined in: [lib/provable/gadgets/gadgets.ts:42](https://github.com/o1-labs/o1js/blob/cc18a919fe40be152afb1b603c57d74a9b2225b0/src/lib/provable/gadgets/gadgets.ts#L42)
...
Defined in: [lib/provable/gadgets/blake2b.ts:76](https://github.com/o1-labs/o1js/blob/cc18a919fe40be152afb1b603c57d74a9b2225b0/src/lib/provable/gadgets/blake2b.ts#L76)
...
Prove that each of the given [Field3](#field3) elements is "almost" reduced modulo f,
i.e., satisfies the assumptions required by [Gadgets.ForeignField.mul](#foreignfield) and other gadgets:
...
Note: This is much more efficient than using [Gadgets.ForeignField.add](#foreignfield) and [Gadgets.ForeignField.sub](#foreignfield) separately to
compute the multiplication inputs and outputs, and then using [Gadgets.ForeignField.mul](#foreignfield) to constrain the result.

The sums passed into this method are "lazy sums" created with [Gadgets.ForeignField.Sum](#foreignfield).
You can also pass in plain [Field3](#field3) elements.

**Assumptions**: The assumptions on the _summands_ are analogous to the assumptions described in [Gadgets.ForeignField.mul](#foreignfield):
...
See [Gadgets.ForeignField.mul](#foreignfield) for assumptions on inputs and usage examples.
...
Different than [Gadgets.ForeignField.mul](#foreignfield), this fails on unreduced input `x`, because it checks that `x === (x/y)*y` and the right side will be reduced.
...
All of the above assumptions are checked by [Gadgets.ForeignField.assertAlmostReduced](#foreignfield).
...
Lazy sum of [Field3](#field3) elements, which can be used as input to [Gadgets.ForeignField.assertMul](#foreignfield).
...
Defined in: [lib/provable/gadgets/sha256.ts:103](https://github.com/o1-labs/o1js/blob/cc18a919fe40be152afb1b603c57d74a9b2225b0/src/lib/provable/gadgets/sha256.ts#L103)
