...
| [DynamicProof](classes/DynamicProof.mdx) | The `DynamicProof` class enables circuits to verify proofs using in-ciruit verification keys. This is opposed to the baked-in verification keys of the `Proof` class. |
